#pragma checksum "C:\Users\gacha\OneDrive\Documents\GitHub\Cinema-Management-System\Falcons\Pages\Cart.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5825c0955953d5322d62850a0d3a62e53bd7ad75"
// <auto-generated/>
...
#nullable disable
#nullable restore
#line 2 "C:\Users\gacha\OneDrive\Documents\GitHub\Cinema-Management-System\Falcons\Pages\Cart.cshtml"
using Newtonsoft.Json;

#line default
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5825c0955953d5322d62850a0d3a62e53bd7ad75", @"/Pages/Cart.cshtml")]
    ...
    public class Pages_Cart : global::Microsoft.AspNetCore.Mvc.RazorPages.Page
    {
        ...
        {
#nullable restore
#line 4 "C:\Users\gacha\OneDrive\Documents\GitHub\Cinema-Management-System\Falcons\Pages\Cart.cshtml"
...
");
            DefineSection("Scripts", async() => {
                WriteLiteral("\r\n    <script>\r\n    $(function () {\r\n");
#nullable restore
#line 38 "C:\Users\gacha\OneDrive\Documents\GitHub\Cinema-Management-System\Falcons\Pages\Cart.cshtml"
...
#nullable restore
#line 43 "C:\Users\gacha\OneDrive\Documents\GitHub\Cinema-Management-System\Falcons\Pages\Cart.cshtml"
...
#nullable disable
                WriteLiteral(";\r\n        var ProductDetail = ");
#nullable restore
#line 44 "C:\Users\gacha\OneDrive\Documents\GitHub\Cinema-Management-System\Falcons\Pages\Cart.cshtml"
...
#nullable disable
                WriteLiteral(";\r\n        var Menu = ");
#nullable restore
#line 45 "C:\Users\gacha\OneDrive\Documents\GitHub\Cinema-Management-System\Falcons\Pages\Cart.cshtml"
...
#nullable disable
        ...
        function AppendToAlarcart");
                WriteLiteral(@"eCart(title, description, price, imgUrl, id) {
            if (imgUrl != ""/assets/img/No-Image.png"") {
        ...
        if (t");
                WriteLiteral(@"ypeof (Storage) !== ""undefined"") {
            let cartMenuArray = [];
                        ...
                        for (let j = 0; j < ProductDetail.length; j++) {
                            if (cartMenuArray[i].ProductDetail[y].ProductDetailID == ProductDetail[j].ProductDetailID) {
                                ...
                                for (let u = 0; u < Product.length; u++) {
                                    ...
                                    if ");
                WriteLiteral(@"(Product[u].ProductID == ProductDetail[j].ProductID) {
                                        console.log(""Found"");
                                        if (y == 0) {
            ...
            if (cartArray.length > 0) {
                ...
                WriteLiteral(@"ductDetail[k].Size + "" x "" + cartArray[i].quantity;
    ...
    ");
                WriteLiteral(@"                        let filtered = []; //declare array list var
                    ...
                    //recreate array list wiithout null element
           ");
                WriteLiteral(@"         filtered = cartMenuArray.filter(function (el) {
                        return el != null;
                    });
                ...
                if (cartProductArray.length > 0) {
                    /*for (let i = 0; i < cartProductArray.length; i++) {
                        if (cartProductArray[i].ProductDetailID == targetID) {
                            ...
                            location.reload(");
                WriteLiteral(@"); //relaod if item is deleted
                        }
                    }*/
        ...
        /*$(""button#checkout"").click(function () {
            ...
            let Products = [];
            let Che");
                WriteLiteral(@"ckoutJsonContainer = new Object();
            if (!(localStorage.getItem(""FnBProductCart"") == null || localStorage.getItem(""FnBProductCart"") == """")) {
