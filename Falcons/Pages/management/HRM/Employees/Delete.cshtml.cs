...
namespace Falcons.Pages.management.HRM.Employees
{
    ...
    public class DeleteModel : DI_BasePageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(int? id)
        {
            ...
            EmployeeList = await _context.Employees.FirstOrDefaultAsync(m => m.EmpID == id);
        ...
        public async Task<IActionResult> OnPostAsync(int? id)
        {
            ...
            EmployeeList = await _context.Employees.FindAsync(id);

            if (EmployeeList != null && EmployeeList.EmployeeLeave == null)
            {
